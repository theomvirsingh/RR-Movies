...
import { asynloadtv, removetv } from "../../GlobalStore/actions/tvActions";
...
const TvDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="relative w-screen min-h-[220vh] mb-[5%] h-auto  px-[10%] pt-4 "
    >
      {/* PART 1 : Navigation */}
      ...
      <div className="w-full pt-3 flex ">
        ...
        <div className="content ml-10 text-white">
          ...
          <h1 className="text-xl mt-2 font-semibold italic text-zinc-300">
            "{info.detail.tagline}"
          </h1>
          ...
          <Link
            to={`${pathname}/trailer`}
            className="bg-zinc-300 p-3 rounded-xl text-zinc-600 "
          >
            <i className="text-xl ri-play-fill mr-[0.5px] mt-auto"></i>Play
            Trailer
          </Link>
        </div>
      </div>
      ...
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <div key={i} className="w-[15vh] mr-[13%] ">
              <img
                className="shadow-[8px_38px_17px_2px_rgba(0,0,0,0.5)] min-w-[15vw] h-[45vh] object-cover"
                src={
                  s.poster_path
